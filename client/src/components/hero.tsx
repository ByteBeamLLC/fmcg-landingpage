        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
              Turn Any <span className="bg-gradient-to-r from-yellow-200 via-amber-200 to-orange-300 bg-clip-text text-transparent">Product Label</span> Into GCC-Compliant Labels
            </h1>
          ...
          >
            ...
            <motion.img
              ...
              className="absolute top-1/2 -translate-y-1/2 left-1/2 w-28 md:w-36 opacity-80 pointer-events-none z-10 floating-product-3d"
              style={{ x: '-20rem' }}
              animate={{
                y: [0, -20, 0],
                rotate: [0, 5, 0],
