...
const NEW_URL = "https://recipebuilder.bytebeam.co/blog/gcc-document-compliance-automation-2026";
const TITLE = "GCC Document Compliance Automation: A No-Code Approach for 2026";
